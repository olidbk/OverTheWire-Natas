...
My personal notes and writeups for the **OverTheWire Natas** wargame.
...
The challenges are designed to teach practical web application security skills through hands-on problem solving.
...
* Keep personal reference notes
* Reinforce web security concepts
